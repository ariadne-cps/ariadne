...
FIND_PATH(GLPK_INCLUDE_DIR NAMES glpk.h PATHS
  HINTS ${GLPK_INCLUDE_DIR} 
  /usr/local/include 
  /usr/local/include/glpk/include
  NO_DEFAULT_PATH
)

FIND_PATH(GLPK_LIBRARIES_DIR  NAMES libglpk.so PATHS
  ${SIMPATH}/basics/glpk/lib
  ${SIMPATH}/local/lib
  ${SIMPATH}/local/lib
  /usr/local/lib
  /usr/lib/x86_64-linux-gnu/
  /usr/local/include/glpk/lib
  NO_DEFAULT_PATH
)

find_library(GLPK_LIBRARIES NAMES libglpk.so
