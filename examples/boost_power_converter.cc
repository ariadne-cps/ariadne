...
HybridAutomaton create_boost_power_converter()
{
    ...
    //VectorAffineFunction open_dyamic(2, 0.0,E/L, 2, -1/RC,1/C, -1/L,0.0);
    // Open, V<E  dot(V)=-V/RC; I=0;
    //VectorAffineFunction saturated_dyamic(1, 0.0, 1, -1/RC);
    // Closed,   dot(V)=-V/RC; dot(I)=E/L
    //VectorAffineFunction closed_dyamic(2, 0.0,E/L, 2, -1/RC,0.0, 0.0,0.0);
