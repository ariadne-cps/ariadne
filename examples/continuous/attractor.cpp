...
void ariadne_main()
{
    ...
    LOGGING_PRINTLN_VAR(initial_constraint_set);
    LOGGING_PRINTLN_VAR(safe_constraint_set);
    ...
    LOGGING_PRINTLN("Evolving with affine integrator...");
    ...
    LOGGING_PRINTLN("Evolving with nonlinear integrator...");
