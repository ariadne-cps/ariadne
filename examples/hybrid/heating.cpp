...
void ariadne_main()
{
    ...
    LOGGING_PRINTLN_VAR(heating_system);
    ...
    LOGGING_PRINTLN_VAR(initial_enclosure);

    HybridTime evolution_time(2.75_x,127);
    LOGGING_PRINTLN_VAR(evolution_time);

    LOGGING_PRINTLN_VAR("Computing orbit using series integrator...");
    ...
    LOGGING_PRINTLN("Computed " << series_orbit.reach().size() << " reach enclosures and " << series_orbit.final().size() << " final enclosures.");
    ...
    LOGGING_PRINTLN("Plotting time trace of orbit... ");
    ...
    LOGGING_PRINTLN_VAR(evolution_termination);

    LOGGING_PRINTLN("Computing event-terminated orbit using series integrator...");
    evolver.set_integrator(series_integrator);
    ...
    LOGGING_PRINTLN("Computing chain-reachable set...");
    HybridStorage chain_reach_set = analyser.outer_chain_reach(initial_set);
    LOGGING_PRINTLN("done.");
    LOGGING_PRINTLN("Plotting chain-reachable set...");
