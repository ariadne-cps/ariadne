...
AtomicHybridAutomaton getController1()
{
    ...
    DiscreteEvent e_can_open("open1");
    DiscreteEvent e_can_close("close1");
    DiscreteEvent e_must_open("mustopen1");
    DiscreteEvent e_must_close("mustclose1");
