...
int main()
{
    ...
    valve.new_transition(open,start_closing,opening,(next(alpha)=alpha),height>=hmax);
    valve.new_transition(opening,start_closing,opening,(next(alpha)=alpha),height>=hmax);
