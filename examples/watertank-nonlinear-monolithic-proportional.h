/***************************************************************************
 *            watertank-nonlinear-monolithic-proportional.h
 *
...
#ifndef WATERTANK_NONLINEAR_MONOLITHIC_PROPORTIONAL_H_
#define WATERTANK_NONLINEAR_MONOLITHIC_PROPORTIONAL_H_

#include "ariadne.h"

namespace Ariadne {

HybridAutomaton getWatertankNonlinearMonolithicProportional()
{
...
#endif /* WATERTANK_NONLINEAR_MONOLITHIC_PROPORTIONAL_H_ */
