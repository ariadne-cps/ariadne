...
Kleenean Polyhedron::overlaps(const ExactBox& bx) const {
    ARIADNE_NOT_IMPLEMENTED;
}

Kleenean Polyhedron::covers(const ExactBox& bx) const {
    ARIADNE_NOT_IMPLEMENTED;
}

Kleenean Polyhedron::separated(const ExactBox& bx) const {
    ARIADNE_NOT_IMPLEMENTED;
}
