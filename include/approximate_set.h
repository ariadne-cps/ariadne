 ...
 */
class ApproximateSet /* FOR PIETER: This class should be inherited from some 
...
{
		/*! \brief The denotable set used for the
		 * approximation. */
	...
	public:
		 ...
		 */
		ApproximateSet* intersect(const ApproximateSet& set) 
			const;
		 ...
		 */
		AbstractDenotableSet* subtract(
				const AbstractDenotableSet &set) const;
