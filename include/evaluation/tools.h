...
#ifndef ARIADNE_TOOLS_H
#define ARIADNE_TOOLS_H
...
class Tools
{
 ...
 public:
  ...
  //! touch the set specified by the \a guard model under the \a flow_model. The \a maximum_time 
  //! gives the maximum time for which the evolution is valid.
  ...
  //! the \a guard_model under evolution of the \a flow_model, for times up to the \a maximum_time.
