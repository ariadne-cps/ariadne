...
template<class X> 
void
instantiate_polynomial_variable()
{
  Function::PolynomialVariable<X>* ts = 0;
  Function::PolynomialVariable<X>* tv = 0;
  - *tv;
  *tv + *tv;
  *tv - *tv;
  *tv * *tv;
...
template<class X> 
void
Function::PolynomialVariable<X>::instantiate()
{ 
  instantiate_polynomial_variable<X>();
}
