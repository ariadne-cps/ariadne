...
template<> class ScalarFunctionModel<Interval>
{
  ...
  public:
    ...
    operator ScalarFunction<Interval>() { return ScalarFunction<Interval>(this->_ptr->_clone()); }
...
template<> class VectorFunctionModel<Interval>
{
  ...
  public:
    ...
    inline VectorFunctionModel(Nat n, const ScalarFunctionModelInterface<Interval>& sf) : _ptr(sf._create_vector(n)) { }
