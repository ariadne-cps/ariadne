...
namespace Ariadne {
    ...
    { 
     ...
     public:
      ...
      explicit Grid(const Vector<R>& v);
      ...
      explicit Grid(const Box<R>& r, const LatticeBlock& lb);
      ...
      LatticeBlock index_block(const Box<R>& r) const;
      ...
      Box<R> rectangle(const LatticeBlock& indices) const;
    ...
    template<class R> class FiniteGrid {
     public:
       ...
       * a lattice block. */
      FiniteGrid(const Grid<R>& g, const LatticeBlock& b);
      ...
      const LatticeBlock& lattice_block() const;
