...
namespace Ariadne {
  namespace Geometry {
    ...
    template<class R>
    inline tribool disjoint(const Sphere<R>& A, const Sphere<R>& B) 
    {
    ...
    template<class R>
    inline tribool disjoint(const Sphere<R>& A, const Rectangle<R>& B) 
    {
      throw NotImplemented(__PRETTY_FUNCTION__);
    }
    
    template<class R>
    inline tribool disjoint(const Rectangle<R>& A, const Sphere<R>& B) 
    {
      return disjoint(B,A);
    }
    ...
    template<class R>
    inline tribool subset(const Sphere<R>& A, 
                       const Sphere<R>& B) 
    {
      throw NotImplemented(__PRETTY_FUNCTION__);
    ...
    template<class R>
    inline tribool subset(const Rectangle<R>& A, 
                       const Sphere<R>& B) 
    {
      throw NotImplemented(__PRETTY_FUNCTION__);
