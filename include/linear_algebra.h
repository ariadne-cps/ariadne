...
/* PAY ATTENTION!!! I supose that boost::numeric::ublas::matrix is row based i.e. 
 A(i,j) is the element in the i-th row and in the j-th column */
template <typename Real>
boost::numeric::ublas::matrix<Real> lu_decompose(const boost::numeric::ublas::matrix<Real> &A, 
...
/* PAY ATTENTION!!! I supose that boost::numeric::ublas::matrix is row based i.e. 
 A(i,j) is the element in the i-th row and in the j-th column */
template <typename Real>
boost::numeric::ublas::vector<Real> lu_solve(const boost::numeric::ublas::matrix<Real> &A, 
...
template <typename Real>
boost::numeric::ublas::matrix<Real> invert_matrix(const boost::numeric::ublas::matrix<Real> &A) {
