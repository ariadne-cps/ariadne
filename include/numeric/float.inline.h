...
// Inline functions for general floating-point numbers
...
template<class T>
inline void decr(Float<T>& x) {
  next_(x,x,round_up); }
template<class T> 
inline void incr(Float<T>& x) {
  next_(x,x,round_up); }

template<class T> 
inline Float<T> prec(const Float<T>& x) {
  return next(x,round_down); }
template<class T> 
inline Float<T> succ(const Float<T>& x) {
...
template<class T> 
inline Float<T> abs(const Float<T>& x) {
...
template<class T> 
inline Float<T> mul_up(const int& x, const Float<T>& y) { 
  Float<T> r; mul_(r,x,y,round_up); return r; }
template<class T> 
inline Float<T> mul_down(const int& x, const Float<T>& y) { 
  Float<T> r; mul_(r,x,y,round_down); return r; }
template<class T> 
inline Float<T> mul_approx(const int& x, const Float<T>& y) { 
  Float<T> r; mul_(r,x,y,round_approx); return r; }

template<class T> 
inline Float<T> mul_up(const unsigned int& x, const Float<T>& y) { 
  Float<T> r; mul_(r,x,y,round_up); return r; }
template<class T> 
inline Float<T> mul_down(const unsigned int& x, const Float<T>& y) { 
  Float<T> r; mul_(r,x,y,round_down); return r; }
template<class T> 
inline Float<T> mul_approx(const unsigned int& x, const Float<T>& y) { 
  Float<T> r; mul_(r,x,y,round_approx); return r; }
...
template<class T> 
inline Float<T> mul_up(const Float<T>& x, const unsigned int& y) { 
  Float<T> r; mul_(r,x,y,round_up); return r; }
template<class T> 
inline Float<T> mul_down(const Float<T>& x, const unsigned int& y) { 
  Float<T> r; mul_(r,x,y,round_down); return r; }
template<class T> 
inline Float<T> mul_approx(const Float<T>& x, const unsigned int& y) { 
  Float<T> r; mul_(r,x,y,round_approx); return r; }
...
inline Float<T> div_approx(const Float<T>& x, const int& y) { 
  Float<T> r; div_(r,x,y,round_approx); return r; }
template<class T> 
inline Float<T> div_up(const Float<T>& x, const unsigned int& y) { 
  Float<T> r; div_(r,x,y,round_up); return r; }
template<class T> 
inline Float<T> div_down(const Float<T>& x, const unsigned int& y) { 
  Float<T> r; div_(r,x,y,round_down); return r; }
template<class T> 
inline Float<T> div_approx(const Float<T>& x, const unsigned int& y) { 
  Float<T> r; div_(r,x,y,round_approx); return r; }
template<class T> 
