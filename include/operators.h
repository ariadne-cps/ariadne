...
struct Neg {
    template<class T> T operator()(const T& a) const { return Ariadne::neg(a); }
    Operator code() const { return NEG; } };
struct Rec {
    template<class T> T operator()(const T& a) const { return Ariadne::rec(a); }
    Operator code() const { return REC; } };
struct Sqr {
    template<class T> T operator()(const T& a) const { return Ariadne::sqr(a); }
    Operator code() const { return SQR; } };
struct Sqrt {
    template<class T> T operator()(const T& a) const { return Ariadne::sqrt(a); }
    Operator code() const { return SQRT; } };

struct Exp {
    template<class T> T operator()(const T& a) const { return Ariadne::exp(a); }
    Operator code() const { return EXP; } };
struct Log {
    template<class T> T operator()(const T& a) const { return Ariadne::log(a); }
    Operator code() const { return LOG; } };
struct Sin {
    template<class T> T operator()(const T& a) const { return Ariadne::sin(a); }
    Operator code() const { return SIN; } };
struct Cos {
    template<class T> T operator()(const T& a) const { return Ariadne::cos(a); }
    Operator code() const { return COS; } };
struct Tan {
    template<class T> T operator()(const T& a) const { return Ariadne::tan(a); }
