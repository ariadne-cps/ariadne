...
namespace Ariadne {
    ...
    template<class R>
    dotstream& 
    operator<<(dotstream& dots, const HybridAutomaton<R>& ha) 
    {
      typedef typename HybridAutomaton<R>::discrete_transition_const_iterator transition_iterator;
