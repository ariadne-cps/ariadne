...
template<class X> class ScalarFunctionHandle;
typedef ScalarFunctionHandle<Interval> IntervalScalarFunction;
template<class X> class VectorFunctionHandle;
typedef VectorFunctionHandle<Interval> IntervalVectorFunction;
...
template<class X, class R> class ConstraintTemplate;
typedef ConstraintTemplate<Real,Real> Constraint;
typedef ConstraintTemplate<Interval,Float> ValidatedConstraint;
    ...
    , public CompactSetInterface
{
  ...
  public:
    ...
    explicit Enclosure(const IntervalVector& d, const IntervalVectorFunction& f, const List<ValidatedConstraint>& c, const IntervalFunctionModelFactoryInterface& fac);
    ...
    explicit Enclosure(const IntervalVector& d, const IntervalVectorFunction& f, const ValidatedConstraint& c, const IntervalFunctionModelFactoryInterface& fac);
    //! \brief Construct a set with a single constraint \a c. \deprecated Use a list of constraints instead
