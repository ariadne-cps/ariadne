    ...
    : public SimulationToolboxInterface
{
  ...
  public:
    ...
    tribool active(const ScalarFunction& guard,
    ...
    TimeType crossing_time(const ScalarFunction& guard,
    ...
    Point reset_step(const VectorFunction& map,
                     const Point& point) const;
    ...
    //! should be flowed.
    Point integration_step(const VectorFunction& vector_field,
                           const Point& initial_point,
