...
Float64Template<Exact>::Float64Template() : _v(0.0) { }

Float64Template<Exact>::Float64Template(Integer value) : _v(value.get_si()) { assert(_v==this->get_flt()); }

//Float64Template<Exact>::Float64Template(double value) : _v(value) { }

Float64Template<Exact>::Float64Template(Flt64 value) : _v(value) { }

Float64Template<Exact>::Float64Template(Int64 n) : _v(n.get_si()) { assert(_v==n.get_si()); }
...
Float64Template<Bound>::Float64Template() : _l(0.0), _u(0.0) {
}

Float64Template<Bound>::Float64Template(double x) : _l(x), _u(x) {
}

Float64Template<Bound>::Float64Template(double x, Exact) : _l(x), _u(x) {
}

Float64Template<Bound>::Float64Template(Flt64 value) : _l(value), _u(value) {
}

Float64Template<Bound>::Float64Template(const Integer& z) : BoundFloat64(Rational(z)) {
}

Float64Template<Bound>::Float64Template(const Rational& q) : _l(q.get_d()), _u(q.get_d()) {
    while(Rational(Flt64(_l))>q) { _l=sub_opp(_l,1e-300); }
    while(Rational(Flt64(_u))<q) { _u=add_rnd(_u,1e-300); }
}

Float64Template<Bound>::Float64Template(LowerFloat64 lower, UpperFloat64 upper) : _l(lower.get_d()), _u(upper.get_d()) {
}

Float64Template<Bound>::Float64Template(double lower, double upper) : _l(lower), _u(upper) {
}
...
Float64Template<Error>::Float64Template() : _e(0.0) { }
Float64Template<Error>::Float64Template(double eb) : _e(eb) {
    if(eb<0) { std::cerr<<"ERROR: eb="<<std::scientific<<std::setprecision(1)<<eb<<"\n"; } assert(eb>=-0.0); }
Float64Template<Error>::Float64Template(Flt64 eb) : _e(eb) { }
Float64Template<Error>::Float64Template(UpperFloat64 ub) : _e(ub.get_flt()) {
...
ErrorFloat64 operator*(ErrorFloat64 x, UpperFloat64 y) {  assert(y.raw()>0.0); return ErrorFloat64(mul_rnd(x._e,y.get_d())); }
ErrorFloat64 operator/(ErrorFloat64 x, LowerFloat64 y) {  assert(y.raw()>0.0); return ErrorFloat64(div_rnd(x._e,y.get_d())); }
ErrorFloat64& operator+=(ErrorFloat64& x, ExactFloat64 y) { ARIADNE_ASSERT(y.raw()>=0.0); x._e=x._e+y.get_d(); return x; }
...
Float64Template<Metrc>::Float64Template() : _v(0.0), _e(0.0) { }
Float64Template<Metrc>::Float64Template(double x) : _v(x), _e(0.0) { }
Float64Template<Metrc>::Float64Template(double x, IsExactTag) : _v(x), _e(0.0) { }
Float64Template<Metrc>::Float64Template(double x, double r) : _v(x), _e(r) {
    if(!(r>=0.0)) { std::cerr<<"Error: MetrcFloat64(x,r) with x="<<x<<", r="<<r<<"\n"; } assert(r>=0.0); }
Float64Template<Metrc>::Float64Template(ExactFloat64 value, ErrorFloat64 error)
    : _v(value.get_d()), _e(error.get_d()) { assert(_e>=0.0); }
Float64Template<Metrc>::Float64Template(Flt64 value) : _v(value), _e(0.0) { }
Float64Template<Metrc>::Float64Template(Integer const& z) : MetrcFloat64(BoundFloat64(z)) { }
Float64Template<Metrc>::Float64Template(Rational const& q) : MetrcFloat64(BoundFloat64(q)) { }
...
Float64Template<Lower>::Float64Template() : _l(0.0) { }
Float64Template<Lower>::Float64Template(double lb, Exact) : _l(lb) { }
Float64Template<Lower>::Float64Template(Flt64 value) : _l(value) { }
Float64Template<Lower>::Float64Template(Integer const& z) : LowerFloat64(BoundFloat64(z)) { }
Float64Template<Lower>::Float64Template(Rational const& q) : LowerFloat64(BoundFloat64(q)) { }
...
Float64Template<Upper>::Float64Template() : _u(0.0) { }
Float64Template<Upper>::Float64Template(double ub, Exact) : _u(ub) { }
Float64Template<Upper>::Float64Template(Flt64 value) : _u(value) { }
Float64Template<Upper>::Float64Template(Integer const& z) : UpperFloat64(BoundFloat64(z)) { }
Float64Template<Upper>::Float64Template(Rational const& q) : UpperFloat64(BoundFloat64(q)) { }
...
Float64Template<Apprx>::Float64Template()
    : _a(0.0) {
}

Float64Template<Apprx>::Float64Template(double value)
    : _a(value) {
}

Float64Template<Apprx>::Float64Template(Flt64 value)
    : _a(value) {
}

Float64Template<Apprx>::Float64Template(const Integer& z)
    : _a(z.get_si()) {
}

Float64Template<Apprx>::Float64Template(const Rational& q)
    : _a(q.get_d()) {
}
