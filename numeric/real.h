...
class Real
{
  ...
  public:
    ...
    explicit Real(ExactFloat x); // TODO: Should this be explicit or not??
    ...
    friend EffectiveNumber operator+(EffectiveNumber,EffectiveNumber);
    friend EffectiveNumber operator-(EffectiveNumber,EffectiveNumber);
    friend EffectiveNumber operator*(EffectiveNumber,EffectiveNumber);
    friend EffectiveNumber operator/(EffectiveNumber,EffectiveNumber);
    friend Logical<Lower> operator==(EffectiveNumber,EffectiveNumber);
    friend Logical<Effective> operator< (EffectiveNumber,EffectiveNumber);
