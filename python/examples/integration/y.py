...
block=LatticeBlock("[-2,102]x[98,281]")
...
initial_rectangle=Rectangle("[0.0,0.0]x[1.0,1.0]")
...
bounding_box=Rectangle("[-0.01,1.01]x[0.99,2.8]")
...
eps=EpsPlot()
eps.open("y-affine.eps",bounding_box,0,1)
...
print "Exporting to postscript output...",
eps.open("y-lohner.eps",bounding_box,0,1)
...
print "Exporting to postscript output...",
eps.open("y-euler.eps",bounding_box,0,1)
