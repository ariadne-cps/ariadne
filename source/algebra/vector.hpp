    ...
    : public VectorContainer<Vector<X>>
{
  ...
  public:
    ...
    X& at(SizeType i) { ARIADNE_PRECONDITION_MSG(i<this->size(),*this<<"["<<i<<"]"); return static_cast<X&>(this->_ary.at(i)); }
    ...
    X& operator[](SizeType i) { return static_cast<X&>(this->_ary[i]); }
...
template<class UB> decltype(auto) characteristics(Interval<UB> const& x) {
