...
template<class P, class F> MultifunctionModel<P,RealVector(RealVector),F>::
    MultifunctionModel(BoxDomainType dom, VectorMultivariateFunction<P> f, BoxDomainType params, Sweeper<F> swp)
        : _f(VectorMultivariateTaylorFunctionModel<P,F>(product(dom,params),f,swp)), _as(dom.dimension()) { }
