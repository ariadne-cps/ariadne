...
class SubPavingInterface
    : public virtual ValidatedLocatedSetInterface<RealVector>
    ...
    : public virtual SubPavingInterface
{
  public:
    ...
    virtual Void adjoin_outer_approximation(const EuclideanCompactSetInterface& set, const Nat fineness) = 0;
    virtual Void adjoin_outer_approximation(const UpperBoxType& set, const Nat fineness) = 0;
    virtual Void adjoin_inner_approximation(const EuclideanOpenSetInterface& set, const Nat extent, const Nat fineness) = 0;
    virtual Void adjoin_inner_approximation(const EuclideanSetInterface& set, const Nat fineness) = 0;
...
class PavingHandle
{
  ...
  public:
    ...
    Void adjoin_outer_approximation(const EuclideanCompactSetInterface& set, const Nat fineness) { return this->_ptr->adjoin_outer_approximation(set,fineness); }
    Void adjoin_inner_approximation(const EuclideanOpenSetInterface& set, const Nat extent, const Nat fineness) { return this->_ptr->adjoin_inner_approximation(set,extent,fineness); }
    Void adjoin_inner_approximation(const EuclideanSetInterface& set, const Nat fineness) { return this->_ptr->adjoin_inner_approximation(set,fineness); }
