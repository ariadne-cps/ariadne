...
EuclideanSetInterface* HybridBoxSet::_euclidean_set(DiscreteLocation loc, RealSpace spc) const {
...
EuclideanRegularSetInterface* HybridConstraintSet::_euclidean_set(DiscreteLocation loc, RealSpace spc) const {
