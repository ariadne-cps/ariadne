...
//! \ingroup OptimisationSubModule
//! Solver for nonlinear programming problems using the Karush-Kuhn-Tucker optimalisty conditions without slack variables.
...
//! \ingroup OptimisationSubModule
//! Solver for nonlinear programming problems using the Karush-Kuhn-Tucker optimalisty conditions and slack variables.
