...
namespace Ariadne {
  namespace Geometry {
    ...
    template Zonotope<Real> minkowski_sum(const Zonotope<Real>& z1, const Parallelotope<Real>& z2);
    template Zonotope<Real> minkowski_sum(const Parallelotope<Real>& z1, const Zonotope<Real>& z2);
    ...
    template Zonotope<Real> minkowski_difference(const Zonotope<Real>& z1, const Parallelotope<Real>& z2);
    template Zonotope<Real> minkowski_difference(const Parallelotope<Real>& z1, const Zonotope<Real>& z2);
