...
Zonotope2d::operator Polygon2d() const
{
...
PlanarProjectionMap::PlanarProjectionMap(dimension_type d, dimension_type i, dimension_type j)
  : _d(d), _i(i), _j(j) 
{ 
  if(i>=d || j>=d) { 
