...
void export_evolution_parameters() 
{
  class_< EvolutionParameters<R> >("EvolutionParameters",init<>())
    ...
    .def("minimum_enclosure_radius",&EvolutionParameters<R>::minimum_enclosure_radius)
    .def("maximum_enclosure_radius",&EvolutionParameters<R>::maximum_enclosure_radius)
    ...
    .def("set_minimum_enclosure_radius",(void(EvolutionParameters<R>::*)(double))&EvolutionParameters<R>::set_minimum_enclosure_radius)
    .def("set_maximum_enclosure_radius",(void(EvolutionParameters<R>::*)(double))&EvolutionParameters<R>::set_maximum_enclosure_radius)
