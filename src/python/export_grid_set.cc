...
void export_grid() 
{
  ...
  grid_class.def("origin", &RGrid::origin,return_value_policy<copy_const_reference>());
  grid_class.def("lengths", &RGrid::lengths,return_value_policy<copy_const_reference>());
