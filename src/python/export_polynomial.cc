...
void export_polynomial() 
{
  ...
  class_< Polynomial<R> >("Polynomial",init<>())
    ...
    .def("truncate",(Polynomial<R>(Polynomial<R>::*)(const size_type&,const size_type&,const Rectangle<R>&)const) &Polynomial<R>::truncate)
...
template void export_polynomial<Float>();
