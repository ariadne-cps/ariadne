...
void export_taylor_series()
{
  ...
  taylor_series_class.def("__add__", &add<TS,TS,R>);
  taylor_series_class.def("__add__", &add<TS,TS,A>);
  taylor_series_class.def("__radd__", &radd<TS,TS,double>);
  taylor_series_class.def("__radd__", &radd<TS,TS,R>);
  taylor_series_class.def("__radd__", &radd<TS,TS,A>);
  taylor_series_class.def("__sub__", &sub<TS,TS,TS>);
  taylor_series_class.def("__sub__", &sub<TS,TS,double>);
  taylor_series_class.def("__sub__", &sub<TS,TS,R>);
  taylor_series_class.def("__sub__", &sub<TS,TS,A>);
  taylor_series_class.def("__rsub__", &rsub<TS,TS,double>);
  taylor_series_class.def("__rsub__", &rsub<TS,TS,R>);
  taylor_series_class.def("__rsub__", &rsub<TS,TS,A>);
  taylor_series_class.def("__mul__", &mul<TS,TS,TS>);
  taylor_series_class.def("__mul__", &mul<TS,TS,double>);
  taylor_series_class.def("__mul__", &mul<TS,TS,R>);
  taylor_series_class.def("__mul__", &mul<TS,TS,A>);
  taylor_series_class.def("__rmul__", &rmul<TS,TS,double>);
  taylor_series_class.def("__rmul__", &rmul<TS,TS,R>);
  taylor_series_class.def("__rmul__", &rmul<TS,TS,A>);
  taylor_series_class.def("__div__", &div<TS,TS,TS>);
  taylor_series_class.def("__div__", &div<TS,TS,double>);
  taylor_series_class.def("__div__", &div<TS,TS,R>);
  taylor_series_class.def("__div__", &div<TS,TS,A>);
  taylor_series_class.def("__rdiv__", &rdiv<TS,TS,double>);
  taylor_series_class.def("__rdiv__", &rdiv<TS,TS,R>);
  taylor_series_class.def("__rdiv__", &rdiv<TS,TS,A>);
