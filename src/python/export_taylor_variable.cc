...
void export_taylor_variable()
{
  ...
  taylor_variable_class.def("__add__", &add<TD,TD,TD>);
  taylor_variable_class.def("__add__", &add<TD,TD,double>);
  taylor_variable_class.def("__add__", &add<TD,TD,R>);
  taylor_variable_class.def("__add__", &add<TD,TD,A>);
  taylor_variable_class.def("__radd__", &radd<TD,TD,double>);
  taylor_variable_class.def("__radd__", &radd<TD,TD,R>);
  taylor_variable_class.def("__radd__", &radd<TD,TD,A>);
  taylor_variable_class.def("__sub__", &sub<TD,TD,TD>);
  taylor_variable_class.def("__sub__", &sub<TD,TD,double>);
  taylor_variable_class.def("__sub__", &sub<TD,TD,R>);
  taylor_variable_class.def("__sub__", &sub<TD,TD,A>);
  taylor_variable_class.def("__rsub__", &rsub<TD,TD,double>);
  taylor_variable_class.def("__rsub__", &rsub<TD,TD,R>);
  taylor_variable_class.def("__rsub__", &rsub<TD,TD,A>);
  taylor_variable_class.def("__mul__", &mul<TD,TD,TD>);
  taylor_variable_class.def("__mul__", &mul<TD,TD,double>);
  taylor_variable_class.def("__mul__", &mul<TD,TD,R>);
  taylor_variable_class.def("__mul__", &mul<TD,TD,A>);
  taylor_variable_class.def("__rmul__", &rmul<TD,TD,double>);
  taylor_variable_class.def("__rmul__", &rmul<TD,TD,R>);
  taylor_variable_class.def("__rmul__", &rmul<TD,TD,A>);
  taylor_variable_class.def("__div__", &div<TD,TD,TD>);
  taylor_variable_class.def("__div__", &div<TD,TD,double>);
  taylor_variable_class.def("__div__", &div<TD,TD,R>);
  taylor_variable_class.def("__div__", &div<TD,TD,A>);
  taylor_variable_class.def("__rdiv__", &rdiv<TD,TD,double>);
  taylor_variable_class.def("__rdiv__", &rdiv<TD,TD,R>);
  taylor_variable_class.def("__rdiv__", &rdiv<TD,TD,A>);
  taylor_variable_class.def("__pow__", &pow<TD,TD,int>);
...
void export_taylor_variable<Rational>()
{
  ...
  taylor_variable_class.def("__add__", &add<TD,TD,TD>);
  taylor_variable_class.def("__add__", &add<TD,TD,double>);
  taylor_variable_class.def("__add__", &add<TD,TD,Q>);
  taylor_variable_class.def("__radd__", &radd<TD,TD,double>);
  taylor_variable_class.def("__radd__", &radd<TD,TD,Q>);
  taylor_variable_class.def("__sub__", &sub<TD,TD,TD>);
  taylor_variable_class.def("__sub__", &sub<TD,TD,double>);
  taylor_variable_class.def("__sub__", &sub<TD,TD,Q>);
  taylor_variable_class.def("__rsub__", &rsub<TD,TD,double>);
  taylor_variable_class.def("__rsub__", &rsub<TD,TD,Q>);
  taylor_variable_class.def("__mul__", &mul<TD,TD,TD>);
  taylor_variable_class.def("__mul__", &mul<TD,TD,double>);
  taylor_variable_class.def("__mul__", &mul<TD,TD,Q>);
  taylor_variable_class.def("__rmul__", &rmul<TD,TD,double>);
  taylor_variable_class.def("__rmul__", &rmul<TD,TD,Q>);
  taylor_variable_class.def("__div__", &div<TD,TD,TD>);
  taylor_variable_class.def("__div__", &div<TD,TD,double>);
  taylor_variable_class.def("__div__", &div<TD,TD,Q>);
  taylor_variable_class.def("__rdiv__", &rdiv<TD,TD,double>);
  taylor_variable_class.def("__rdiv__", &rdiv<TD,TD,Q>);
  taylor_variable_class.def("__pow__", &pow<TD,TD,int>);
  taylor_variable_class.def(self_ns::str(self));
...
template void export_taylor_variable<Float>();
