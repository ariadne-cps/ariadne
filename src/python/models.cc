...
{
  export_henon_map<Ariadne::FloatPy>();
  export_duffing_equation<Ariadne::FloatPy>();
  export_van_der_pol_equation<Ariadne::FloatPy>();
  export_lorenz_system<Ariadne::FloatPy>();
}
