...
struct TaylorModel::Accuracy {
    ...
    bool discard(const Float& x) const { return x<this->_sweep_threshold; }
...
// This method is hugely inefficient; use acc2 instead
...
// In profiling, mul2 yielded best results
