...
template<class R>
HybridEvolverPlugin<R> construct_evolver_plugin() 
{
...
int main() {
  ...
  TestHybridEvolverPlugin<Float>().test();
  cerr << "INCOMPLETE ";
  return 0;
}
