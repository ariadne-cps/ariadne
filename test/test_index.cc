...
class TestSortedIndex
{
 public:
  int test_construct() {
    ...
    ARIADNE_TEST_EVALUATE(s1);
    ARIADNE_TEST_EVALUATE(SortedIndex(4,4,a2));
    ARIADNE_TEST_EVALUATE(s2);
  ...
  int test_compare() {
    ...
    ARIADNE_TEST_CONSTRUCT(SortedIndex,s1,(4,3,a1));
    ARIADNE_TEST_CONSTRUCT(SortedIndex,s2,(4,3,a2));
    ARIADNE_TEST_CONSTRUCT(SortedIndex,s3,(4,4,a3));
    ARIADNE_TEST_CONSTRUCT(SortedIndex,s4,(4,4,a4));
    SortedIndex s5(5,4,a4);
    
    ARIADNE_TEST_ASSERT(!(s1<s1));
    ARIADNE_TEST_ASSERT(s1<s2);
    ARIADNE_TEST_ASSERT(s3==s4);
    //ARIADNE_TEST_FAIL(s4==s5);
  ...
  int test_increment() {
    ...
    ARIADNE_TEST_CONSTRUCT(SortedIndex,s0,(4));
    ARIADNE_TEST_CONSTRUCT(SortedIndex,s1,(4,5,a1));
    ARIADNE_TEST_CONSTRUCT(SortedIndex,s2,(4,5,a2));
    ARIADNE_TEST_CONSTRUCT(SortedIndex,s3,(4,5,a3));
    ARIADNE_TEST_CONSTRUCT(SortedIndex,s4,(4,5,a4));
    ARIADNE_TEST_CONSTRUCT(SortedIndex,s5,(4,5,a5));
    ARIADNE_TEST_CONSTRUCT(SortedIndex,s6,(4,5,a6));
    ARIADNE_TEST_CONSTRUCT(SortedIndex,s7,(4,6,a7));
    ARIADNE_TEST_EVALUATE(++s0);
    ARIADNE_TEST_ASSERT(++s1==s2);
  ...
  int test_position() {
    ...
    for(uint i=0; i!=n; ++i) {
      if(i!=s.position()) {
        ARIADNE_TEST_EVALUATE(s);
        ARIADNE_TEST_CHECK(s.position(),i);
      }
      ++s;
    }
    ARIADNE_TEST_EVALUATE(s);
    ARIADNE_TEST_CHECK(s.position(),n);
    return 0;
  }
...
class TestMultiIndex
{
 public:
  ...
  int test_conversion() {
    ...
    ARIADNE_TEST_CONSTRUCT(PositionIndex,p1,(4,143));
    ARIADNE_TEST_CONSTRUCT(PositionIndex,p2,(4,14));
    ...
    ARIADNE_TEST_EVALUATE(SortedIndex(p2));
    ARIADNE_TEST_EVALUATE(MultiIndex(PositionIndex(4,1234)))
