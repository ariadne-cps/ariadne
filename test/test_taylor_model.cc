...
void TestTaylorModel::test_constructors()
{
    ...
    ARIADNE_TEST_CONSTRUCT(TaylorModel,tv2,(E(2,10, 0,0,1.0, 1,0,2.0, 0,1,3.0, 2,0,4.0, 1,1,5.0, 0,2,6.0, 3,0,7.0, 2,1,8.0, 1,2,9.0, 0,3,10.0), 0.25));
...
void TestTaylorModel::test_split()
{
    ...
    TaylorModel es3=1+1.5*x+2*y-1.25*x*x-3.5*x*y+11*y*y;
