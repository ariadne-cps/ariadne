...
template<class X>
bool operator==(const PowerSeries<X>& ts1, const PowerSeries<X>& ts2) {
...
class TestPowerSeries {
 public:
  ...
  void test_degree() {
    PowerSeries<X> x1=PowerSeries<X>::variable(3,1.0);
    ARIADNE_TEST_ASSERT(x1.degree()==3);
  }

  void test_add() {
    PowerSeries<X> x1=PowerSeries<X>::variable(3,1.0);
    PowerSeries<X> x2=PowerSeries<X>::variable(3,2.0);
    double ax1px2[4]={3,2,0,0};
    ARIADNE_TEST_ASSERT((x1+x2)==PowerSeries<X>(3,ax1px2));
  }
  ...
  void test_sub() {
    ...
    ARIADNE_TEST_ASSERT((x1-x2)==PowerSeries<X>(3,ax1sx2));
  }
  ...
  void test_mul() {
    ...
    PowerSeries<X> x1(4,ax1);
    PowerSeries<X> x2(4,ax2);
    PowerSeries<X> x1mx2(4,ax1mx2);
  ...
  void test_div() {
    ...
    PowerSeries<X> x1(3,ax1);
    PowerSeries<X> x2(3,ax2);
    PowerSeries<X> x3(2,ax3);
    PowerSeries<X> x4(2,ax4);
    ARIADNE_TEST_EQUAL((x3/x4),x3);
    ARIADNE_TEST_EQUAL((x4/x3),PowerSeries<X>(2,ax4dx3));
    ARIADNE_TEST_EQUAL((x4/x3)*x3,x4);
    ARIADNE_TEST_EQUAL(((1/x2)*x2),PowerSeries<X>::constant(3,1.0));
    ARIADNE_TEST_EQUAL((1/x2),PowerSeries<X>(3,aodx2));
    ARIADNE_TEST_EQUAL(((x1/x2)*x2),x1);
    ARIADNE_TEST_EQUAL((x1/x2),PowerSeries<X>(3,ax1dx2));
  }

  void test_pow() {
    PowerSeries<X> x2=PowerSeries<X>::variable(3,2.0);
    double ax2p5[4]={32,80,80,40};
    ARIADNE_TEST_EQUAL(pow(x2,5),PowerSeries<X>(3,ax2p5));
  }
  ...
  void test_compose() {
    ...
    double aid[6]={ax[0],1};
    PowerSeries<X> x(5,ax);
    PowerSeries<X> y(5,ay);
    PowerSeries<X> z(5,az);
    PowerSeries<X> id(5,aid);
    cout << "x="<<x<<"\n";
    cout << "y="<<y<<"\n";
    cout << "z="<<z<<"\n";
