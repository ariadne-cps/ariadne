...
class TestZonotope
{
  ...
  Zonotope<R> z2d, z3d, z2d5g;
 public:
  TestZonotope() 
  {
    double a2d[6]={ 1,0,  2,1, -1,1 };
    double a3d[12]={ 0.0,1.0,-1.5,  2.0,1.0,0.1, 1.0,1.0,0.0, -1.5,0.5,0.375 };
    double a2d5g[12]={1,0,  2,1, -1,1, -1,3, 1,0, 0,0.5 };

    z2d=Zonotope<R>(2,2,a2d);
    z3d=Zonotope<R>(3,3,a3d);
    z2d5g=Zonotope<R>(2,5,a2d5g);
  }
