...
class TestConstrainedImageSet
{
  ...
  public:
    ...
    Void test_geometry() {
        ...
        // Test the unit disc
        EffectiveConstrainedImageSet disc({EffectiveIntervalType(-2,+2),EffectiveIntervalType(-2,+2)},{x[0],x[1]});
        ...
        EffectiveConstrainedImageSet parabola({EffectiveIntervalType(-1,+1)},{p[0],p[0]*p[0]});
