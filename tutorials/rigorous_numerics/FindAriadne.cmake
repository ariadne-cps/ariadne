...
find_library(CONCLOG_LIBRARY conclog)
find_library(BETTERTHREADS_LIBRARY betterthreads)
set(ARIADNE_LIBRARIES "${ARIADNE_LIBRARY}")
set(CONCLOG_LIBRARY "${CONCLOG_LIBRARY}")
set(BETTERTHREADS_LIBRARY "${BETTERTHREADS_LIBRARY}")
...
find_package_handle_standard_args(Ariadne DEFAULT_MSG ARIADNE_LIBRARIES CONCLOG_LIBRARY BETTERTHREADS_LIBRARY ARIADNE_INCLUDE_DIRS)

mark_as_advanced(
  ARIADNE_INCLUDE_DIRS
  ARIADNE_LIBRARIES
  CONCLOG_LIBRARY
  BETTERTHREADS_LIBRARY
)
