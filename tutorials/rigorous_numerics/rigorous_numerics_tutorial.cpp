...
#define print(expr) { LOGGING_PRINTLN(#expr << ": " << (expr)) }
...
int main(int argc, const char* argv[]) {
    ...
    LOGGING_PRINTLN("Linear Algebra");
    {
        LOGGING_SCOPE_CREATE;
